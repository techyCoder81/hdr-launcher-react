...
export const stageInfo: Record<string, Stage> = {
    ...
    Mario_Castle64: { display_name:  "Peach's Castle 64", layout: Layout.BiplatMoving },
    DK_Jungle: { display_name:  "DK Jungle 64", layout: Layout.DkJungle },
    Zelda_Hyrule: { display_name:  "Hyrule Castle 64", layout: Layout.HyruleCastle64 },
    ...
    Mario_CastleDx: { display_name:  "Princess Peach's Castle", layout: Layout.Unknown },
    ...
    Yoshi_Yoster: { display_name:  "Yoshi's Island (Melee)", layout: Layout.Unknown },
    Yoshi_CartBoard: { display_name:  "Yoshi's Story", layout: Layout.TriPlat },
    Kirby_Fountain: { display_name:  "Fountain of Dreams", layout: Layout.TriplatMoving },
    ...
    Poke_Stadium: { display_name:  "Pokémon Stadium", layout: Layout.ReasonableTransform },
    Mother_Onett: { display_name:  "Onett", layout: Layout.Unknown },
    Mario_PastUsa: { display_name:  "Mushroom Kingdom II", layout: Layout.Unknown },
    Metroid_Kraid: { display_name:  "Brinstar Depths", layout: Layout.Unknown },
    Yoshi_Story: { display_name:  "Yoshi's Island (Brawl)", layout: Layout.Unknown },
    ...
    Metroid_Orpheon: { display_name:  "Frigate Orpheon", layout: Layout.BiplatMoving },
    ...
    Fzero_Porttown: { display_name:  "Port Town Aero Dive", layout: Layout.Unknown },
    ...
    MG_Shadowmoses: { display_name:  "Shadow Moses Island", layout: Layout.BiPlat },
    ...
    Mario_NewBros2: { display_name:  "Mushroom Kingdom 2", layout: Layout.Unknown },
    ...
    Icarus_Uprising: { display_name:  "Reset Bomb Forest", layout: Layout.Asymmetric },
    ...
    Animal_City: { display_name:  "Town & City", layout: Layout.ReasonableTransform },
